 ...
 * @typedef { import('js/sweetalert2/sweetalert2').SweetAlertOptions } SweetAlertOptions
 * @typedef { import('js/sweetalert2/sweetalert2').SweetAlertCustomClass } SweetAlertCustomClass
 * @typedef { import('js/sweetalert2/sweetalert2').SweetAlertIcon } SweetAlertIcon
 * @typedef { import('js/sweetalert2/sweetalert2').SweetAlertInput } SweetAlertInput
 * @typedef { import('js/sweetalert2/sweetalert2').SweetAlertResult } SweetAlertResult
 * @typedef { import('js/sweetalert2/sweetalert2').SweetAlertOptions['inputValue'] } SweetAlertInputValue
 */
